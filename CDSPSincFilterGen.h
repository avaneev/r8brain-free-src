...
private:
	...
	static const double* getKaiserParams( const int FilterLen2 )
	{
		...
		static const double Coeffs[][ 2 ] = {
			{ 2.6504246356892924, 1.9035845248358245 }, // 6 @ -51.73
			{ 4.0759654812373016, 1.5747323142948524 }, // 8 @ -67.11
			{ 4.9036508646352033, 1.6207644759455790 }, // 10 @ -81.84
			{ 5.6131421124830716, 1.6947677220415129 }, // 12 @ -96.40
			{ 5.9433751253133691, 1.8730186383321272 }, // 14 @ -111.13
			{ 6.8308658253825660, 1.8549555120377224 }, // 16 @ -125.46
			{ 7.6648458853758372, 1.8565765953924642 }, // 18 @ -139.74
			{ 8.2038730802326842, 1.9269521308895179 }, // 20 @ -154.05
			{ 8.7865151489187561, 1.9775307528231671 }, // 22 @ -168.21
			{ 9.5945013206755156, 1.9718457932433306 }, // 24 @ -182.11
			{ 10.5163048616210250, 1.9504085061576968 }, // 26 @ -195.57
			{ 10.2382664677006100, 2.1608878780497056 }, // 28 @ -209.06
			{ 10.9976663155261660, 2.1536415815428249 }, // 30 @ -222.50
		};
