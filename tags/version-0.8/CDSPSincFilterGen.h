...
public:
	...
	void initFracVaneev( const int FilterLen, const double* Params = NULL )
	{
		...
		static const double Coeffs[][ 4 ] = {
			{ 0.78181357, 0.25515445, 0.14160659, 0.00377970 }, // 6 @ -138.38
			{ 0.82842159, 0.46796048, 0.03723786, 0.01647440 }, // 8 @ -154.06
			{ 0.87106048, 0.55487482, 0.11407443, 0.06108434 }, // 10 @ -167.61
			{ 0.90233911, 0.62228911, 0.17793224, 0.09128849 }, // 12 @ -181.02
			{ 0.92827344, 0.67928146, 0.18506467, 0.15682281 }, // 14 @ -194.79
			{ 0.94714902, 0.71154551, 0.36654152, 0.01684227 }, // 16 @ -208.13
			{ 0.95678003, 0.75499443, 0.40432469, 0.09098344 }, // 18 @ -223.09
			{ 0.94515247, 0.78611177, 0.47023918, 0.10753907 }, // 20 @ -234.21
			{ 0.95415054, 0.80837403, 0.50606780, 0.14824214 }, // 22 @ -248.43
			{ 0.79522327, 0.92805771, 0.54353064, 0.17844054 }, // 24 @ -261.55
			{ 0.96847593, 0.83511595, 0.56732297, 0.21510544 }, // 26 @ -275.76
			{ 0.96901504, 0.85795109, 0.57843751, 0.25070613 }, // 28 @ -285.63
			{ 0.97022013, 0.86906266, 0.59856588, 0.28601037 }, // 30 @ -297.61
			{ 0.97374957, 0.88090262, 0.62906580, 0.29736763 }, // 32 @ -309.87
			{ 0.81824544, 0.95632121, 0.67943518, 0.35354651 }, // 34 @ -325.37
			{ 0.83224964, 0.96134546, 0.68783822, 0.37241201 }, // 36 @ -334.97
			{ 0.60217397, 0.96734066, 0.76693619, 0.40644160 }, // 38 @ -346.97
		};
